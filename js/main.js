...
document.onreadystatechange = function() {
    ...
    $('sg-badComments').children[0].style.display = 'block';
...
// var html = window.template('test', data);
// document.getElementById('content').innerHTML = html;


//  http://a.tbcdn.cn/sys/common/icon/rank_s/b_red_1.gif 一颗心 图标
//创建Node
// var taobaoAssistant;
...
//     dbody.appendChild(fragment);
// }



// //插入页面
var referenceElement = document.getElementsByClassName('sep-line')[0];
//referenceElement.parentNode.insertBefore(taobaoAssistant, referenceElement);
...
mainInfo.innerHTML = '<div id="sg-shoppingGuide"><ul class="sg-nav sg-nav-tabs"> <li class="sg-active">搜狗打假助手</li> <li>网购建议</li></ul><div class="sg-nav-content"><ul><li>开店时长{{shopStartDate[0]}}年{{shopStartDate[1]}}</li><li><p>近30天退款率为{{ratRefund.localVal}}, 退款{{ratRefund.refundCount}}次</p><p>近30天纠纷率为{{complaints.localVal}}, 纠纷退款{{complaints.disputRefundNum}}笔</p><p>近30天被处罚{{punish.punishCount}}次, 出售假冒商品{{punish.cPunishTimes}}次, 虚假交易{{}}次</p></li><li><p>评价匿名率: {{anonyCommentsRate}}</p><p>成交记录匿名率: {{anonyTradeRate}}</p><p>交易成功比例: {{successRate}}</p></li><li><span>商品中差评:{{(badCommentList&&badCommentList.length) || 0}}条</span><span>卖家所有中差评: {{(allBadCommentList&&allBadCommentList.length)|| 0}}</span><span>查看所有</span></li></ul></div><div class="sg-nav-content"><ul><li></li></ul></div></div>';
...
badCommentsTmp.innerHTML = '<div class="sg-comments-header"><span class="sg-comments-hide"></span></div><div id="reviews"><div class="tb-revhd tb-rev-beta"><ul class="tb-r-comments">{{each badComments as value i}}<li tabindex="0" hidefocus="true" class="tb-r-review" data-uid=""><div class="tb-r-buyer"><div class="tb-r-avatar"><span class="tb-r-ulink"><img class="tb-r-uimg" width="40" height="40" src="{{value["user"]["avatar"]}}"><br><span class="tb-r-unick">{{value["user"]["nick"]}}</span></span><br></div></div><div class="tb-r-bd"><div class="WTF" style="width:100%;height:32px;line-height:32px;vertical-align:middle;color:red;font-size:2em;font-weight:bold"></div><div class="tb-rev-item" data-id="222763816660"><div class="tb-r-cnt">{{value["content"]}}</div><div class="tb-r-photos J_PhotoBrowserRoot"><ul class="tb-r-photos-thumb"></ul><div class="tb-r-photo-viewer J_ViewStage" style="display:none"><div class="tb-r-photo-viewer-bar"><a href="#" class="J_Hide"><span class="tb-r-photo-icon tb-r-photo-icon-hide"></span>收起</a><a href="#" class="J_Open" target="_blank"><span class="tb-r-photo-icon tb-r-photo-icon-open"></span>原图</a><a href="#" class="J_TurnLeft"><span class="tb-r-photo-icon tb-r-photo-icon-turnleft"></span>向左转</a><a href="#" class="J_TurnRight"><span class="tb-r-photo-icon tb-r-photo-icon-turnright"></span>向右转</a></div><div class="J_StageMain tb-r-photo-stage-main"><a href="#" hidefocus="on" class="J_Prev tb-r-photo-btn-prev"> <i></i></a><a href="#" hidefocus="on" class="J_Next tb-r-photo-btn-next"> <i></i></a><div class="tb-r-photo-stage-imgbox J_Imgbox"></div></div></div></div><div class="tb-r-act-bar"><div class="tb-r-info"><span class="tb-r-date">{{value["date"]}}</span><span class="tb-r-sku">{{value["auction"]["sku"]}}</span></div><ul class="tb-rev-actions"><li class="tb-rev-action"><span class="tb-r-markuseful"><span class="tb-r-action-btn" title="有{{value["useful"]}}人认为此评论有用" data-act="markuseful" data-val="222763816660">有用</span><span class="tb-r-count-useful">({{value["useful"]}})</span><div class="tb-r-useful-msg"><div class="tb-r-useful-cnt">content</div> <b class="tb-r-useful-arrow"></b> <b class="tb-r-useful-arrow-up"></b></div></span></li></ul></div><div class="tb-rev-comment"><div class="tb-r-sns-comment"></div></div></div>{{if value["append"]}}<div class="tb-rev-item tb-rev-item-append" data-id="223401715296"><div class="tb-r-cnt"><span class="tb-r-label-append">["追加评论"]</span>{{value["append"]["content"]}}</div><div class="tb-r-act-bar"><div class="tb-r-info">确认收货后{{value["append"]["dayAfterConfirm"]}}天追加</div><ul class="tb-rev-actions"></ul></div><div class="tb-rev-comment"><div class="tb-r-sns-comment"></div></div></div>{{/if}}</div></li>{{/each}}</ul></div></div>';
allBadCommentsTmp.innerHTML = '<div class="sg-comments-header"><span class="sg-comments-hide"></span></div>{{each allBadComments as value i}}<div class="rate-item"><div class="rate-auction"><a target="_blank" class="J_MakePoint" data-point-val="tbrate.2.14" href="http://trade.taobao.com/trade/detail/trade_snap.htm?trade_id=810728667632507">{{value["auction"]["title"]}}</a><div class="price">¥ <em>{{value["auction"]["auctionPrice"]}}</em></div></div><div class="rate-type"><span class="rate-icon rate-bad" title="差评"></span><br></div><div class="rate-userinfo"><a target="_blank" class="J_MakePoint" data-point-val="tbrate.2.12" href="{{value["user"]["nickUrl"]}}">{{value["user"]["nick"]}}</a><br><a target="_blank" class="J_MakePoint" data-point-val="tbrate.2.13" href="{{value["user"]["rankUrl"]}}"><img align="absmiddle" title="91 - 150个 买家信用积分" src="http://a.tbcdn.cn/sys/common/icon/rank/b_red_4.gif" alt="91 - 150个"></a><a target="_blank" href="http://vip.taobao.com"><img border="0" align="absmiddle" class="rank" title="V2 会员" src="http://img03.taobaocdn.com/tps/i3/T1FHuIXcNkXXXXXXXX-16-16.png"></a></div><div class="rate-content"><div class="tb-r-body"><div class="tb-r-cnt">{{value["content"]}}</div><div class="tb-r-info"><span class="tb-r-date">{{value["date"]}}</span><span class="tb-r-sku">{{value["auction"]["sku"]}}</span></div></div></div></div>{{/each}}';
dbody.appendChild(badCommentsTmp);
dbody.appendChild(allBadCommentsTmp);
// badCommentsTmp.addListener('click', function(e){
//     if(e.target.className === 'sg-comments-hide') {
//         this.className = 'sg-comments-header hide';
//     }
// });
// allBadCommentsTmp.addListener('click', function(e){
//     if(e.target.className === 'sg-comments-hide') {
//         this.className = 'sg-comments-header hide';
//     }
// });
